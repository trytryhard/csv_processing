...
def test_cnt():
    """test COUNT-report"""
    res_cnt = [["year", "continent", "country(cnt)"],
    [["2023", "Europe", 10],
    ["2023", "Asia", 8],
    ["2022", "Asia", 5],
    ["2022", "Europe", 5],
    ...
    res_func = main(files=[r".\test_data\fine_file.csv",r".\test_data\fine_file2.csv"],
                    report="cnt-country",
...
def test_sum():
    ...
    res_sum = [
        ...
        [
            ["2022", 42.7],
             ["2023", 46.800000000000004],
             ["2021", 79.49999999999999]
        ]       ]

    res_func = main(files=[r".\test_data\fine_file.csv",
            r".\test_data\fine_file2.csv"],
                    report="sum-gdp_growth",
                    groupby=["year"],
                    encoding="1251",
                    descending="0", separator=",")
...
def test_err_encoding():
    ...
    with pytest.raises(NameError) as exc_info:
        main(files=[r".\test_data\fine_file.csv"],
                    report="mode-year",
                    groupby=["continent"],
...
def test_err_content():
    ...
    with pytest.raises(NameError) as exc_info:
        main(files=[r".\test_data\corrupted_content.csv"],
                    report="avg-year",
                    groupby=["continent"],
                    encoding="utf8",
                    descending="0",
